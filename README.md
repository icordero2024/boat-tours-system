...
## How to use
1. Install Docker desktop and login, leave docker open you'll need it for the rest of the steps.
2. Run this bash code line (you can use git bash):

```bash
docker compose up -d --build
```

This will automatically create all the containers in docker

3. Enter into this URL: http://localhost:5173/ 
